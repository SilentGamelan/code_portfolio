//  Apply Functional Programming to Convert Strings to URL Slugs.js
...
console.log(globalTitle.match(reggy));

// Add your code below this line
function urlSlug(title) {
    let reggy = /\w+/g;
    let slugged = title.toLowerCase().match(reggy).reduce((acc, item) => {
        return acc + "-" + item;
    });
